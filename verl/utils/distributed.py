...
def initialize_global_process_group(timeout_second=36000):
    ...
    torch.distributed.init_process_group(
        f"cpu:gloo,{get_device_name()}:{get_nccl_backend()}",
