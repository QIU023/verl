...
_MODEL_TYPE_TO_FAMILY: dict[str, ContinuousTokenModelFamily] = {
    ...
    # Kimi K3 renders through the same MoonViT processor path; the processor call
    # itself is K3-aware (build_multimodal_processor_inputs).
    "kimi_k3": ContinuousTokenModelFamily.KIMI_VL,
